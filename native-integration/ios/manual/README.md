...
> 🔄 **Keep it in sync.** `Vendor/ApplaudIQEmbed/` is a **copy** of the SDK at **v1.0.2** — it won't update
> itself. On a version bump, re-copy from the SDK repo:
> `git -C applaudiq-embed-ios show 1.0.2:Sources/ApplaudIQEmbed/ApplaudIQEmbed.swift`.
