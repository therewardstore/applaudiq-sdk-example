...
// THIS app's SSO callback deep link (scheme://host). Register the scheme natively (iOS Info.plist
// CFBundleURLSchemes + Android intent-filter) — see the README. The SDK sends it as `native_redirect`.
