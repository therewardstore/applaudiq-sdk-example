...
@Component({
  selector: 'app-needs-server-notice',
  standalone: true,
  template: `
    <div class="aiq-callout">
      <h3>Auto-login needs a server</h3>
      <p>
        Wire <code>getEmbedToken()</code> in <code>src/app/embed-token.service.ts</code> to your
...
export class NeedsServerNoticeComponent {}
